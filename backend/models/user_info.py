...
class userTable(Base):
    ...
    client_id = Column(String(30), ForeignKey("Client_table.client_id"),index=True)
    ...
    user_district = Column(String(50),nullable=True)
    created_by = Column(DateTime,default=func.now()) 
    client = relationship("ClientTable", backref="users")